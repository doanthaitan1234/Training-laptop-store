...
@section('title')
    <title>
        {{ __('Admin') }} -{{ __('Edit') }} {{ __('Product') }}</title>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong>{{ __('Edit') }} {{ __('Product') }}</strong>
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="description" id="textarea-input" rows="5"
                                        class="ckeditor form-control">{{ old('description', $product->description) }}</textarea>
                                    @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 row mt-3 image-list">
                                    @if (isset($images))
                                        @foreach ($images as $image)
                                            <span class="image-cover col-4">
                                                <img class="image-thumb" src="{{ asset($image->path) }}">
                                                <span class="remove"><i class="fa fa-times-circle icon-remove"
